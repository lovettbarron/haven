...
| Kale Nero di Toscana | (60, 65) | Harvest and remove if space needed for tomato/pepper zone. | W21 |
| Calendula #1 | (90, 40) | Remove if space needed. | W21 |
...
### Middle Zone: Herbs & Salad (L=120 to ~170cm)

Afternoon shade from ~14:00. Lettuce bolts slower, leeks and broccoli thrive here.
...
L=120|        |                    |                   |         |
     |        |  ~~~~~~~~LETTUCE ZONE~~~~~~~~          |         |
L=125|        | (broadcast: 20-60, 125-140)            |         |
     |        |  (bolts Jun+, replaced by leeks)       |         |
L=130|        |                    |  ===SON ROW===    |         |
     |        |                    |  (W=60-110, L=130,|         |
L=135|        |                    |   5-8cm apart)    |         |
     |        |                    |           DIL-2   |         |
...
| Symbol | Plant | Center Position (W,L cm) | Spread/Spacing | Sow/Plant |
|--------|-------|--------------------------|----------------|-----------|
| **LET** | Baby lettuce (broadcast) | Zone: 20-60cm W, 125-140cm L | 5cm density | W16 -- broadcast sow |
| **SON** | Spring onion White Lisbon | Row at L=130, W=60-110cm | 5-8cm apart | W16 -- direct sow |
| **LEK-1** | Leek Musselburgh #1 | (60, 145) | 15cm apart | W21 -- transplant seedling |
...
| Symbol | Plant | Center Position (W,L cm) | Spread/Spacing | Sow/Plant |
|--------|-------|--------------------------|----------------|-----------|
| **RB-1** | Raspberry Autumn Bliss #1 | (60, 185) | 25cm spacing | W16 -- bare-root cane |
| **RB-2** | Raspberry Autumn Bliss #2 | (60, 210) | 25cm spacing | W16 -- bare-root cane |
| **RB-3** | Raspberry Autumn Bliss #3 | (60, 225) | 25cm spacing | W16 -- bare-root cane |
| **CHV** | Chive division #1 | (5, 180) | 15-20cm | W16 -- division |
| **CHV** | Chive division #2 | (115, 180) | 15-20cm | W16 -- division |
| **CHV** | Chive division #3 | (5, 200) | 15-20cm | W16 -- division |
| **CHV** | Chive division #4 | (115, 200) | 15-20cm | W16 -- division |
| **CHV** | Chive division #5 | (5, 220) | 15-20cm | W16 -- division |
| **CHV** | Chive division #6 | (115, 220) | 15-20cm | W16 -- division |

### Radish Succession Slot

| Symbol | Plant | Center Position (W,L cm) | Spread/Spacing | Sow/Plant |
|--------|-------|--------------------------|----------------|-----------|
| **RAD** | Radish succession slot | Zone: 80-100cm W, 125-145cm L | 20x20cm area | W18 start, re-sow every 2 weeks |

### Mint Pot (Outside Bed)

| Symbol | Plant | Position | Spread/Spacing | Sow/Plant |
|--------|-------|----------|----------------|-----------|
| **MINT** | Mint (spearmint/peppermint) | Outside bed, east side, on ground | 30cm+ pot | W21 -- buy plant |
...
**Pepper -- the Color-Change Watch (row 85cm):**
- Sweet pepper (Lipstick) at (60, 85) -- center of the bed
...
This zone benefits from the 14:00 afternoon shade. Lettuce does not bolt as fast, leeks handle partial shade well, and broccoli does not need full-day sun. This is a feature, not a bug.

**Lettuce broadcast zone (20-60cm W, 125-140cm L):**
- Cut-and-come-again baby lettuce mix, broadcast-sown at 5cm density
- Harvest outer leaves from W20 onward -- the "snip and eat" zone
- **Bolts in summer heat (June+).** When lettuce bolts, pull plants and the zone is clear for leek transplants.
- While lettuce is growing, this is the bed's most immediately rewarding section: fast germination, visible growth, and edible results within weeks.
- **Lettuce cutting with child scissors** -- the child snips leaves at the base. Low motor-skill barrier, tangible result, goes straight to the kitchen.

**Spring onion row (L=130, W=60-110cm):**
- White Lisbon spring onions, 5-8cm apart across a ~50cm row
- ~8-10 spring onions in the row
- 60-90 days to harvest. Pull as needed for kitchen use.
- Compatible with leeks (both alliums, no conflict)
- Positioned on the east half of the bed, leaving the west half for the lettuce broadcast zone

**Leeks (Musselburgh):**
- 3 pencil-thick transplant seedlings along the center line (W=60cm)
- LEK-1 at (60, 145), LEK-2 at (60, 155), LEK-3 at (60, 165) -- 10cm spacing
- **Planting method:** Use a dibber or thick stick to make 15cm deep holes. Drop seedling in, water gently to settle soil around roots. Do NOT backfill the hole -- it fills naturally as the leek grows. The deep hole blanches the stem (white development).
- Leeks are upright and compact -- well-suited to the center line of the bed
- Harvest from autumn into winter (90-120 days from transplant)
- Leeks tolerate light frost -- they will be among the last crops harvested in the season (W40+)
- Replace bolted lettuce zone in summer

**Broccoli Calabrese at (100, 150):**
- 1 transplant seedling, positioned in the east half of the middle zone
- The 120cm bed width means broccoli leaves (40-50cm spread) can spread without overhanging bed edges -- a significant improvement over the old 40cm Bed C
...
- 20x20cm area on the east side of the lettuce zone
- Sow radish from W18, re-sow every 2 weeks
- Fast turnaround: 3-4 weeks seed to harvest
- Perfect quick-win activity for the child

### Buffer (L=170-180cm)

- ~10cm open strip between the middle zone and the raspberry zone
...
- RB-1 at (60, 185), RB-2 at (60, 210), RB-3 at (60, 225)
...
- 2 clumps per row at L=180, 200, 220 (west at W=5, east at W=115)
...
- The 120cm width gives generous room for chives at the perimeter without crowding the canes
...
### Mint Pot (Outside the Bed)

- NOT inside the bed -- mint is invasive and would take over
- 30cm+ pot with drainage hole, placed on the ground next to the bed on the east side
- Spearmint or peppermint
- Part of the daily sensory route
...
| LEK | Leek Musselburgh | 10cm apart along center | 15cm deep (blanching) | W21 (May 20+) | Transplant pencil-thick seedlings. 90-120 days to harvest. Frost-tolerant. |
| BRC | Broccoli Calabrese | 40-50cm leaf spread | Root ball depth | W21 (May 20+) | 1 transplant. Harvest main head + side shoots. 120cm width gives room for leaf spread. |
| RB | Raspberry Autumn Bliss | Center line, 25cm apart | 8cm deep | W16 | Bare-root canes. Self-supporting. Fruit Aug-Oct year 1. Late-summer picking treat. |
| CHV | Chive divisions | 15-20cm apart around perimeter | Root depth | W16 | Repel Japanese beetles + aphids. Purple flowers May-Jun. |
| RAD | Radish (succession) | 5cm apart | 1cm deep | W18, then every 2 weeks | Fill the succession slot. Harvest in 3-4 weeks. |
| CAL | Calendula | 20-25cm apart | 0.5cm deep | W16 | Pest deterrent. Phase 2 placement; may be removed W21 for space. |
| MINT | Mint (spearmint/peppermint) | Pot only | Root depth | W21 | Buy plant. 30cm+ pot with drainage. NOT in bed. Daily sensory route. |

---

## Succession Sowing Slots
...
| Dill + broccoli | Dill attracts hoverflies that eat broccoli aphids and cabbage caterpillars | GOOD |
...
This bed concentrates all the child's garden activities in one place:
...
This bed satisfies or contributes to:
...
|--------|-------|-------|-------|
| CROP-01 | | x | Strawberries in Bed B |
| CROP-02 | x | | Tomato Sungold |
| CROP-03 | x | | Cucumber Mini Munch x2 |
| CROP-04 | x | | Sweet pepper Lipstick |
| CROP-05 | x | | Raspberry Autumn Bliss x3 |
| CROP-06 | x | | Radish succession slot |
| ENGM-01 | | x | Sunflower height measurement in Bed B |
| ENGM-02 | x | | Baby lettuce broadcast zone |
| ENGM-04 | x | | Companion planting layout |
| COOK-01 | x | | Spring onions |
| COOK-03 | x | | Leeks Musselburgh x3 |
| COOK-04 | x | | Bush beans x6 |
| COOK-07 | x | | Broccoli Calabrese |
| SENS-05 | x | | Basil alongside tomato |
| CRTR-01 | x | | Borage + dill for pollinators/hoverflies |
| CRTR-02 | | x | Nasturtium trap crop in Bed B |
| FLWR-01 | | x | Nasturtium at bed edge in Bed B |
| FLWR-02 | x | | Calendula near warm crops |
| FLWR-05 | x | | Chive flowers in raspberry perimeter |
| SENS-03 | | x | Mint pot (placed near Bed B) |
