...
| 5 | HA alert messages reference the correct crops for Bed E (no tomatoes) | VERIFIED | havn_bed_e_moisture_below_min: "broccoli and beans need water" (en+da). havn_bed_e_temperature_below_frost: "beans are frost-sensitive" (en+da). Zero tomato/tomat references in Bed E alert rules. |
